...
package Assets {
	...
	public class FlyingEnemy extends Objects{
		...
		/**Constructor*/
		public function FlyingEnemy(_arena:Stage, xPos:Number, yPos:Number, width:Number, height:Number ,  _settings:SharedObject, _HUD:PlayerHUD, _player:Player, _weapon:Weapon){
