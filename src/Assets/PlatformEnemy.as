...
package Assets {
	...
	public class PlatformEnemy extends Objects{
		...
		/**Constructor*/
		public function PlatformEnemy(xPos:Number, yPos:Number, width:Number, height:Number, type:int, startingDirection:int, _effectsChannel:SoundChannel, _settings:SharedObject){
