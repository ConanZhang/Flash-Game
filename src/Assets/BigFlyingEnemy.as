...
package Assets {
	...
	public class BigFlyingEnemy extends Objects{
		...
		/**Constructor*/
		public function BigFlyingEnemy(_arena:Stage, xPos:Number, yPos:Number, width:Number, height:Number, _settings:SharedObject, _HUD:PlayerHUD, _player:Player, _weapon:Weapon){
