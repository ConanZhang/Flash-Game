...
package Assets {
	...
	public class BigPlatformEnemy extends Objects{
		...
		/**Constructor*/
		public function BigPlatformEnemy(xPos:Number, yPos:Number, width:Number, height:Number, type:int,  startingDirection:int, _effectsChannel:SoundChannel, _settings:SharedObject){
