...
package Assets {
	...
	public class SmallPlatformEnemy extends Objects{
		...
		/**Constructor*/
		public function SmallPlatformEnemy(xPos:Number, yPos:Number, width:Number, height:Number, type:int, startingDirection:int,  _settings:SharedObject, _HUD:PlayerHUD, _player:Player, _weapon:Weapon){
