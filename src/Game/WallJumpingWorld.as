...
package Game
{
	...
	public class WallJumpingWorld extends Stage
	{
		 ...
		 * 
		 */
		public function WallJumpingWorld(screenP:FlashGame, debugging:Boolean, pacifist:Boolean,world:int, difficulty:int, _hasRain:Boolean, _settings:SharedObject,  _musicChannel:SoundChannel, _HUD:PlayerHUD, _keybindings:Object)
		{			
			screen = screenP;
			...
			settings = _settings;
			HUD = _HUD;
			super(screen,debugging, 139.75, -97, pacifist, world, difficulty, _musicChannel, settings, HUD, _keybindings);
