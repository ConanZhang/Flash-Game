...
package Game
{
	...
	public class EarthWorld extends Stage
	{
		 ...
		 * 
		 */
		public function EarthWorld(screenP:FlashGame, debugging:Boolean, pacifist:Boolean, world:int, _difficulty:int, _hasRain:Boolean, _settings:SharedObject,  _musicChannel:SoundChannel, _HUD:PlayerHUD, _keybindings:Object, _player:Player, _weapon:Weapon)
		{			
			screen = screenP;
